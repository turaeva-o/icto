...
document.addEventListener("DOMContentLoaded", async () => {
	...
	cylindermesh.position.set(-1, 0.1, -5);
	...
	cylinder2mesh.position.set(0, 0.1, -5);
	...
	cylinder3mesh.position.set(1, 0.1, -5);
	...
	torusmesh.position.set(-1, -0.37, -5);
	...
	torus2mesh.position.set(-1, -0.2, -5);
	...
	torus3mesh.position.set(-1, -0.03, -5);
	...
	torus4mesh.position.set(-1, 0.14, -5);
	...
	torus5mesh.position.set(-1, 0.31, -5);
	...
	torus6mesh.position.set(-1, 0.48, -5);
	...
	torus7mesh.position.set(-1, 0.65, -5);
