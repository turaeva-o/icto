...
document.addEventListener("DOMContentLoaded", async () => {
	...
	cylindermesh.position.set(-1, 0.1, -2);
	...
	cylinder2mesh.position.set(0, 0.1, -2);
	...
	cylinder3mesh.position.set(1, 0.1, -2);
	...
	torusmesh.position.set(-1, -0.37, -2);
	...
	torus2mesh.position.set(-1, -0.2, -2);
	...
	torus3mesh.position.set(-1, -0.03, -2);
	...
	torus4mesh.position.set(-1, 0.14, -2);
	...
	torus5mesh.position.set(-1, 0.31, -2);
	...
	torus6mesh.position.set(-1, 0.48, -2);
	...
	torus7mesh.position.set(-1, 0.65, -2);
