...
document.addEventListener("DOMContentLoaded", async () => {
	...
	box2mesh.position.set(0, -0.5, -15);
	scene.add(box2mesh);
	...
	box3mesh.position.set(1, -0.5, -15);
	scene.add(box3mesh);
	...
	cylindermesh.position.set(-1, 0.1, -15);
	...
	cylinder2mesh.position.set(0, 0.1, -15);
	...
	cylinder3mesh.position.set(1, 0.1, -15);
	...
	torusmesh.position.set(-1, -0.37, -15);
	...
	torus2mesh.position.set(-1, -0.2, -15);
	...
	torus3mesh.position.set(-1, -0.03, -15);
	...
	torus4mesh.position.set(-1, 0.14, -15);
	...
	torus5mesh.position.set(-1, 0.31, -15);
	...
	torus6mesh.position.set(-1, 0.48, -15);
	...
	torus7mesh.position.set(-1, 0.65, -15);
